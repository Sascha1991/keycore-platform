...
export const stagingCatalog: readonly StagingCatalogProduct[] = [
  {
    ...
    currency: "EUR",
    description: "Synthetisches Abenteuerspiel fuer den sicheren Staging-Test.",
    eligibility: "ALLOWED",
    platform: "PC",
    priceMinor: 1299,
  ...
  },
  {
    ...
    availability: "IN_STOCK",
    currency: "EUR",
    description: "Synthetisches Rennspiel fuer EU-kompatible Konten.",
    eligibility: "ALLOWED",
    platform: "PC",
    priceMinor: 999,
  ...
  },
  {
    ...
    availability: "IN_STOCK",
    currency: "EUR",
    description: "Synthetisches Koop-Spiel fuer den Storefront-Test.",
    eligibility: "ALLOWED",
    platform: "PC",
    priceMinor: 1499,
  ...
  },
  {
    ...
    availability: "IN_STOCK",
    currency: "EUR",
    description: "Synthetisches Sportspiel fuer Deutschland.",
    eligibility: "ALLOWED",
    platform: "Xbox",
    priceMinor: 2199,
