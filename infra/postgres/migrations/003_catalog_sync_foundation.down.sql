...
ALTER TABLE supplier_offers DROP CONSTRAINT IF EXISTS supplier_offers_last_sync_run_fk;
ALTER TABLE supplier_products DROP CONSTRAINT IF EXISTS supplier_products_last_sync_run_fk;
