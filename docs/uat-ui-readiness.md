...
fulfillment for the resulting order, production identity,
...
| Guest purchase claim        | `EXECUTABLE_NOW`                        | One-time verified-same-email synthetic claim through Kauf hinzufügen                      | Human UAT-015 execution and redacted evidence        |
...
| Full browser walkthrough    | `PARTIALLY_EXECUTABLE`                  | Discovery, synthetic checkout, account, Guest Claim and secure reveal surfaces            | Procurement/fulfillment linkage and invoice document |
