...
| Security trust boundaries               | focused SEC-001 through SEC-020 assertions | isolated PostgreSQL ownership and invariants | synthetic adapters and canaries     | critical journey regressions    | no raw canary leakage or unresolved Critical/High finding |
| Database and outage recovery            | environment and corruption guards          | REC-001 through REC-018 native restore audit | no live provider call               | restored application continuity | no duplicate effect, ownership loss or plaintext leakage  |
